...
add('In an EIGRP topology table, a route that is in a/an state will cause the Diffusing Update Algorithm to send EIGRP queries that ask other routers for a path to this network.',
    'active');
add('Open the PT Activity. Perform the tasks in the activity instructions and then answer the question. Which code is displayed on the web server?',
    'Complete');
...
add('first > eigrp, second > IPv4 on loopback, third > IPv4 on active');
