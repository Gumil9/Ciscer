...
add('DateCenter/Ed_Dept Router:');
add('R1name>en');
add('R1name#conf ter');
add('R1name(config)#ip route 0.0.0.0 0.0.0.0 s0/1/0');
add('R1name(config)#ipv6 unicast-routing');
add('R1name(config)#ipv6 route ::/0 s0/1/0');
add('R1name(config)#router eigrp 99');
add('R1name(config-router)#network 192.168.100.8 0.0.0.3');
add('R1name(config-router)#network 192.168.100.20 0.0.0.3');
add('R1name(config-router)#eigrp router-id 1.1.1.1');
add('R1name(config-router)#exit');
add('R1name(config)#ipv6 router eigrp 99');
add('R1name(config-rtr)#eigrp router-id 1.1.1.1');
add('R1name(config-rtr)#no shutdown');
add('R1name(config-rtr)#exit');
add('R1name(config)#int s0/0/0');
add('R1name(config-if)#ipv6 eigrp 99');
add('R1name(config-if)#int s0/0/1');
add('R1name(config-if)#ipv6 eigrp 99');
add('R1name(config-if)#exit');
add('R1name(config)#int s0/1/0');
add('R1name(config-if)#ipv6 eigrp 99');
add('R1name(config-if)#exit');
add('R1name(config)#int s0/0/0');
add('R1name(config-if)#bandwidth 2000');
add('R1name(config-if)#exit');
add('R1name(config)#int s0/0/1');
add('R1name(config-if)#bandwidth 2000');
add('R1name(config-if)#exit');
add('R1name(config)#router eigrp 99');
add('R1name(config-router)#redistribute static');
add('R1name(config-router)#exit');
add('R1name(config)#ipv6 router eigrp 99');
add('R1name(config-rtr)#redistribute static');
add('R1name(config-rtr)#');
add('Clinic_10/Primary-2 Router:');
add('R2-2name>en');
add('R2-2name#conf ter');
add('R2-2name(config)#ip route 0.0.0.0 0.0.0.0 s0/0/0');
add('R2-2name(config)#int g0/0');
add('R2-2name(config-if)#standby 1 ip 10.1.0.1');
add('R2-2name(config-if)#standby version 2');
add('Hospital_1/Primary-1 Router');
add('R2name>en');
add('R2name#conf ter');
add('R2name(config)#router eigrp 99');
add('R2name(config-router)#network 10.1.0.0 0.0.0.255');
add('R2name(config-router)#network 192.168.100.8 0.0.0.3');
add('R2name(config-router)#network 192.168.100.32 0.0.0.3');
add('R2name(config-router)#eigrp router-id 2.2.2.2');
add('R2name(config-router)#exit');
add('R2name(config)#ipv6 unicast-routing');
add('R2name(config)#ipv6 router eigrp 99');
add('R2name(config-rtr)#eigrp router-id 2.2.2.2');
add('R2name(config-rtr)#no shutdown');
add('R2name(config-rtr)#exit');
add('R2name(config)#int s0/0/1');
add('R2name(config-if)#ipv6 eigrp 99');
add('R2name(config-if)#int s0/0/0');
add('R2name(config-if)#ipv6 eigrp 99');
add('R2name(config-if)#int g0/0');
add('R2name(config-if)#ipv6 eigrp 99');
add('R2name(config-if)#exit');
add('R2name(config)#int s0/0/0');
add('R2name(config-if)#bandwidth 2000');
add('R2name(config-if)#exit');
add('R2name(config)#router eigrp 99');
add('R2name(config-router)#passive-interface g0/0');
add('R2name(config-router)#exit');
add('R2name(config)#int g0/0');
add('R2name(config-if)#standby 1 ip 10.1.0.1');
add('R2name(config-if)#standby 1 preempt');
add('R2name(config-if)#standby 1 priority 150');
add('R2name(config-if)#standby version 2');
add('Hospital_2 / High_School Router');
add('R3name>en');
add('R3name#conf ter');
add('R3name(config)#router eigrp 99');
add('R3name(config-router)#network 10.10.0.0 0.0.0.255');
add('R3name(config-router)#network 10.15.0.0 0.0.0.255');
add('R3name(config-router)#network 10.20.0.0 0.0.0.255');
add('R3name(config-router)#network 192.168.100.20 0.0.0.3');
add('R3name(config-router)#network 192.168.100.32 0.0.0.3');
add('R3name(config-router)#eigrp router-id 3.3.3.3');
add('R3name(config-router)#exit');
add('R3name(config)#ipv6 unicast-routing');
add('R3name(config)#ipv6 router eigrp 99');
add('R3name(config-rtr)#eigrp router-id 3.3.3.3');
add('R3name(config-rtr)#no shutdown');
add('R3name(config-rtr)#exit');
add('R3name(config)#int g0/0.10');
add('R3name(config-subif)#ipv6 eigrp 99');
add('R3name(config-subif)#int g0/0.15');
add('R3name(config-subif)#ipv6 eigrp 99');
add('R3name(config-subif)#int g0/0.20');
add('R3name(config-subif)#ipv6 eigrp 99');
add('R3name(config-subif)#exit');
add('R3name(configpv6 eigrp)#int s0/0/0');
add('R3name(config-if)#ipv6 eigrp 99');
add('R3name(config-if)#int s0/0/1');
add('R3name(config-if)#ipv6 eigrp 99');
add('R3name(config-if)#int s0/1/0');
add('R3name(config-if)#ipv6 eigrp 99');
add('R3name(config-if)#exit');
add('R3name(config)#int s0/0/1');
add('R3name(config-if)#bandwidth 2000');
add('R3name(config-if)#exit');
add('R3name(config)#router eigrp 99');
add('R3name(config-router)#passive-interface g0/0.10');
add('R3name(config-router)#passive-interface g0/0.15');
add('R3name(config-router)#passive-interface g0/0.20');
add('R3name(config-router)#exit');
add('R3name(config)#int g0/0');
add('R3name(config-if)#no sh');
add('R3name(config-if)#');
add('Net_1 / Dist-1 Switch');
add('Change VTP domain and VTP Password to match your exam');
add('S1name>en');
add('S1name#conf ter');
add('S1name(config)#int range f0/3-4');
add('S1name(config-if-range)#channel-group 1 mode active');
add('S1name(config-if-range)#int range f0/5-6');
add('S1name(config-if-range)#channel-group 2 mode active');
add('S1name(config-if-range)#exit');
add('S1name(config)#int g0/1');
add('S1name(config-if)#no shutdown');
add('S1name(config-if)#int g0/1');
add('S1name(config-if)#switchport mode trunk');
add('S1name(config-if)#switchport trunk native vlan 99');
add('S1name(config-if)#int g0/1');
add('S1name(config-if)#switchport nonegotiate');
add('S1name(config-if)#int range f0/3-4');
add('S1name(config-if-range)#switchport mode trunk');
add('S1name(config-if-range)#switchport trunk native vlan 99');
add('S1name(config-if-range)#int port-channel 1');
add('S1name(config-if)#switchport mode trunk');
add('S1name(config-if)#switchport trunk native vlan 99');
add('S1name(config-if)#switchport nonegotiate');
add('S1name(config-if)#int range f0/5-6');
add('S1name(config-if-range)#switchport mode trunk');
add('S1name(config-if-range)#switchport trunk native vlan 99');
add('S1name(config-if-range)#int port-channel 2');
add('S1name(config-if)#switchport mode trunk');
add('S1name(config-if)#switchport trunk native vlan 99');
add('S1name(config-if)#switchport nonegotiate');
add('S1name(config-if)#exit');
add('S1name(config)#vtp mode server');
add('S1name(config)#vtp domain TownEd');
add('S1name(config)#vtp password TWE_123!');
add('S1name(config)#vtp version 2');
add('S1name(config)#spanning-tree mode rapid-pvst');
add('S1name(config)#spanning-tree vlan 10,15,20 priority 24576');
add('FL_1 Switch / Acc-1 Switch:');
add('Change VTP domain and VTP Password to match your exam');
add('S2name>en');
add('S2name#conf ter');
add('S2name(config)#int range f0/3-4');
add('S2name(config-if-range)#channel-group 1 mode active');
add('S2name(config-if-range)#int range f0/1-2');
add('S2name(config-if-range)#channel-group 3 mode active');
add('S2name(config-if-range)#exit');
add('S2name(config)#int range f0/3-4');
add('S2name(config-if-range)#switchport mode trunk');
add('S2name(config-if-range)#switchport trunk native vlan 99');
add('S2name(config-if-range)#int port-channel 1');
add('S2name(config-if)#switchport mode trunk');
add('S2name(config-if)#switchport trunk native vlan 99');
add('S2name(config-if)#switchport nonegotiate');
add('S2name(config-if)#int range f0/1-2');
add('S2name(config-if-range)#switchport mode trunk');
add('S2name(config-if-range)#switchport trunk native vlan 99');
add('S2name(config-if-range)#int port-channel 3');
add('S2name(config-if)#switchport mode trunk');
add('S2name(config-if)#switchport trunk native vlan 99');
add('S2name(config-if)#switchport nonegotiate');
add('S2name(config-if)#exit');
add('S2name(config)#vtp mode client');
add('S2name(config)#vtp domain TownEd');
add('S2name(config)#vtp password TWE_123!');
add('S2name(config)#vtp version 2');
add('S2name(config)#spanning-tree mode rapid-pvst');
add('S2name(config)#int range f0/10-24');
add('S2name(config-if-range)#spanning-tree bpduguard enable');
add('S2name(config-if-range)#spanning-tree portfast');
add('Fl_2 Switch / Acc-2 Switch');
add('Change VTP domain and VTP Password to match your exam');
add('S3name>');
add('S3name>en');
add('S3name#conf ter');
add('S3name(config)#int range f0/5-6');
add('S3name(config-if-range)#channel-group 2 mode active');
add('S3name(config-if-range)#int range f0/1-2');
add('S3name(config-if-range)#channel-group 3 mode active');
add('S3name(config-if-range)#exit');
add('S3name(config-if-range)#');
add('S3name(config)#int range f0/5-6');
add('S3name(config-if-range)#switchport mode trunk');
add('S3name(config-if-range)#switchport trunk native vlan 99');
add('S3name(config-if-range)#int port-channel 2');
add('S3name(config-if)#switchport mode trunk');
add('S3name(config-if)#switchport trunk native vlan 99');
add('S3name(config-if)#switchport nonegotiate');
add('S3name(config-if)#int range f0/1-2');
add('S3name(config-if-range)#switchport mode trunk');
add('S3name(config-if-range)#switchport trunk native vlan 99');
add('S3name(config-if-range)#int port-channel 3');
add('S3name(config-if)#switchport mode trunk');
add('S3name(config-if)#switchport trunk native vlan 99');
add('S3name(config-if)#switchport nonegotiate');
add('S3name(config-if)#exit');
add('S3name(config)#vtp mode client');
add('S3name(config)#vtp domain TownEd');
add('S3name(config)#vtp password TWE_123!');
add('S3name(config)#spanning-tree mode rapid-pvst');
add('S3name(config)#spanning-tree vlan 10,15,20 priority 28672');
add('On host PC-B, go to the Desktop tab and open the Command Prompt.');
add('- Enter telnet 2001:DB8:E::1');
add('- Authenticate your Telnet session with the password cisco.');
add('- Move to privileged EXEC mode using the password admin.');
add('External>en');
add('External#conf ter');
add('External(config)#int g0/0');
add('External(config-if)#no sh');
add('Hosts PC-A / PC-M:');
add('Gateway IP address: 10.1.0.1');
